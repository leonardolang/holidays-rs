...
pub fn build(years: &Option<&std::ops::Range<Year>>) -> Result<HashMap<Year, BTreeMap<NaiveDate, Holiday>>> {
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2002, 7, 1)?, "2002년 한일 월드컵 대표팀 4강 진출"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2023, 5, 29)?, "부처님오신날 대체 휴일"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2025, 5, 5)?, "부처님오신날; 어린이날"),
      ...
      (NaiveDate::from_ymd_res(2025, 5, 6)?, "부처님오신날 대체 휴일; 어린이날 대체 휴일"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2026, 5, 25)?, "부처님오신날 대체 휴일"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2027, 12, 27)?, "기독탄신일 대체 휴일"),
    ],
    &mut map,
    Country::KR,
    "South Korea",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2029, 5, 21)?, "부처님오신날 대체 휴일"),
