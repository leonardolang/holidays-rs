...
pub fn build(years: &Option<&std::ops::Range<Year>>) -> Result<HashMap<Year, BTreeMap<NaiveDate, Holiday>>> {
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2002, 1, 28)?, "Australia Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2003, 1, 27)?, "Australia Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2008, 1, 28)?, "Australia Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2013, 1, 28)?, "Australia Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2014, 1, 27)?, "Australia Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2019, 1, 28)?, "Australia Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2020, 1, 27)?, "Australia Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2022, 9, 22)?, "National Day of Mourning for Queen Elizabeth II"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2025, 1, 27)?, "Australia Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2030, 1, 28)?, "Australia Day (observed)"),
