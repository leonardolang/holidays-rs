...
pub fn build(years: &Option<&std::ops::Range<Year>>) -> Result<HashMap<Year, BTreeMap<NaiveDate, Holiday>>> {
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2000, 1, 17)?, "John Chilembwe Day (observed)"),
      ...
      (NaiveDate::from_ymd_res(2000, 5, 15)?, "Kamuzu Day (observed)"),
      (NaiveDate::from_ymd_res(2000, 7, 6)?, "Independence Day"),
      (NaiveDate::from_ymd_res(2000, 10, 15)?, "Mother's Day"),
      (NaiveDate::from_ymd_res(2000, 10, 16)?, "Mother's Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2001, 3, 5)?, "Martyrs Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2002, 3, 4)?, "Martyrs Day (observed)"),
      ...
      (NaiveDate::from_ymd_res(2002, 7, 8)?, "Independence Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2003, 7, 7)?, "Independence Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2004, 5, 3)?, "Labour Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2005, 1, 17)?, "John Chilembwe Day (observed)"),
      ...
      (NaiveDate::from_ymd_res(2005, 5, 16)?, "Kamuzu Day (observed)"),
      (NaiveDate::from_ymd_res(2005, 7, 6)?, "Independence Day"),
      (NaiveDate::from_ymd_res(2005, 10, 15)?, "Mother's Day"),
      (NaiveDate::from_ymd_res(2005, 10, 17)?, "Mother's Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2006, 1, 16)?, "John Chilembwe Day (observed)"),
      ...
      (NaiveDate::from_ymd_res(2006, 5, 15)?, "Kamuzu Day (observed)"),
      (NaiveDate::from_ymd_res(2006, 7, 6)?, "Independence Day"),
      (NaiveDate::from_ymd_res(2006, 10, 15)?, "Mother's Day"),
      (NaiveDate::from_ymd_res(2006, 10, 16)?, "Mother's Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2007, 3, 5)?, "Martyrs Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2008, 7, 7)?, "Independence Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2010, 5, 3)?, "Labour Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2011, 1, 17)?, "John Chilembwe Day (observed)"),
      ...
      (NaiveDate::from_ymd_res(2011, 5, 16)?, "Kamuzu Day (observed)"),
      (NaiveDate::from_ymd_res(2011, 7, 6)?, "Independence Day"),
      (NaiveDate::from_ymd_res(2011, 10, 15)?, "Mother's Day"),
      (NaiveDate::from_ymd_res(2011, 10, 17)?, "Mother's Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2012, 1, 16)?, "John Chilembwe Day (observed)"),
      (NaiveDate::from_ymd_res(2012, 3, 3)?, "Martyrs Day"),
      (NaiveDate::from_ymd_res(2012, 3, 5)?, "Martyrs Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2013, 3, 4)?, "Martyrs Day (observed)"),
      ...
      (NaiveDate::from_ymd_res(2013, 7, 8)?, "Independence Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2014, 7, 7)?, "Independence Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2016, 5, 16)?, "Kamuzu Day (observed)"),
      (NaiveDate::from_ymd_res(2016, 7, 6)?, "Independence Day"),
      (NaiveDate::from_ymd_res(2016, 10, 15)?, "Mother's Day"),
      (NaiveDate::from_ymd_res(2016, 10, 17)?, "Mother's Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2017, 1, 16)?, "John Chilembwe Day (observed)"),
      ...
      (NaiveDate::from_ymd_res(2017, 5, 15)?, "Kamuzu Day (observed)"),
      (NaiveDate::from_ymd_res(2017, 7, 6)?, "Independence Day"),
      (NaiveDate::from_ymd_res(2017, 10, 15)?, "Mother's Day"),
      (NaiveDate::from_ymd_res(2017, 10, 16)?, "Mother's Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2018, 3, 5)?, "Martyrs Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2019, 3, 4)?, "Martyrs Day (observed)"),
      ...
      (NaiveDate::from_ymd_res(2019, 7, 8)?, "Independence Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2021, 5, 3)?, "Labour Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2022, 1, 17)?, "John Chilembwe Day (observed)"),
      ...
      (NaiveDate::from_ymd_res(2022, 5, 16)?, "Kamuzu Day (observed)"),
      (NaiveDate::from_ymd_res(2022, 7, 6)?, "Independence Day"),
      (NaiveDate::from_ymd_res(2022, 10, 15)?, "Mother's Day"),
      (NaiveDate::from_ymd_res(2022, 10, 17)?, "Mother's Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2023, 1, 16)?, "John Chilembwe Day (observed)"),
      ...
      (NaiveDate::from_ymd_res(2023, 5, 15)?, "Kamuzu Day (observed)"),
      (NaiveDate::from_ymd_res(2023, 7, 6)?, "Independence Day"),
      (NaiveDate::from_ymd_res(2023, 10, 15)?, "Mother's Day"),
      (NaiveDate::from_ymd_res(2023, 10, 16)?, "Mother's Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2024, 3, 4)?, "Martyrs Day (observed)"),
      ...
      (NaiveDate::from_ymd_res(2024, 7, 8)?, "Independence Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2025, 7, 7)?, "Independence Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2027, 5, 3)?, "Labour Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2028, 1, 17)?, "John Chilembwe Day (observed)"),
      ...
      (NaiveDate::from_ymd_res(2028, 5, 15)?, "Kamuzu Day (observed)"),
      (NaiveDate::from_ymd_res(2028, 7, 6)?, "Independence Day"),
      (NaiveDate::from_ymd_res(2028, 10, 15)?, "Mother's Day"),
      (NaiveDate::from_ymd_res(2028, 10, 16)?, "Mother's Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2029, 3, 5)?, "Martyrs Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2030, 3, 4)?, "Martyrs Day (observed)"),
      ...
      (NaiveDate::from_ymd_res(2030, 7, 8)?, "Independence Day (observed)"),
