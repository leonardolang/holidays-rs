...
pub fn build(years: &Option<&std::ops::Range<Year>>) -> Result<HashMap<Year, BTreeMap<NaiveDate, Holiday>>> {
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2007, 10, 15)?, "(تقدير) عطلة عيد الفطر; عيد الجلاء"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2008, 3, 20)?, "(تقدير) عيد المولد النبوي; عيد الإستقلال"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2013, 10, 15)?, "(تقدير) عيد الأضحى; عيد الجلاء"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2019, 8, 13)?, "(تقدير) عطلة عيد الأضحى; عيد المرأة"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2026, 3, 20)?, "(تقدير) عيد الفطر; عيد الإستقلال"),
