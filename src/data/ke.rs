...
pub fn build(years: &Option<&std::ops::Range<Year>>) -> Result<HashMap<Year, BTreeMap<NaiveDate, Holiday>>> {
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2002, 10, 21)?, "Kenyatta Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2004, 12, 13)?, "Jamhuri Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2010, 12, 13)?, "Jamhuri Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2013, 10, 21)?, "Mashujaa Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2014, 6, 2)?, "Madaraka Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2019, 10, 21)?, "Mashujaa Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2020, 2, 11)?, "President Moi Celebration of Life Day"),
    ],
    &mut map,
    Country::KE,
    "Kenya",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2021, 10, 11)?, "Utamaduni Day (observed)"),
      (NaiveDate::from_ymd_res(2021, 10, 20)?, "Mashujaa Day"),
      (NaiveDate::from_ymd_res(2021, 12, 12)?, "Jamhuri Day"),
      (NaiveDate::from_ymd_res(2021, 12, 13)?, "Jamhuri Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2022, 4, 29)?, "State Funeral for Former President Mwai Kibaki"),
      (NaiveDate::from_ymd_res(2022, 8, 9)?, "Election Day"),
      (NaiveDate::from_ymd_res(2022, 9, 10)?, "Day of Mourning for Queen Elizabeth II"),
      (NaiveDate::from_ymd_res(2022, 9, 11)?, "Day of Mourning for Queen Elizabeth II"),
      (NaiveDate::from_ymd_res(2022, 9, 12)?, "Day of Mourning for Queen Elizabeth II"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2024, 10, 21)?, "Mashujaa Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2025, 6, 2)?, "Madaraka Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2027, 10, 11)?, "Utamaduni Day (observed)"),
      (NaiveDate::from_ymd_res(2027, 10, 20)?, "Mashujaa Day"),
      (NaiveDate::from_ymd_res(2027, 12, 12)?, "Jamhuri Day"),
      (NaiveDate::from_ymd_res(2027, 12, 13)?, "Jamhuri Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2030, 10, 21)?, "Mashujaa Day (observed)"),
