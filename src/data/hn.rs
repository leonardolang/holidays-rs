...
pub fn build(years: &Option<&std::ops::Range<Year>>) -> Result<HashMap<Year, BTreeMap<NaiveDate, Holiday>>> {
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2000, 10, 21)?, "Día de las Fuerzas Armadas"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2001, 4, 14)?, "Día de las Américas; Sábado de Gloria"),
      ...
      (NaiveDate::from_ymd_res(2001, 10, 21)?, "Día de las Fuerzas Armadas"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2002, 10, 21)?, "Día de las Fuerzas Armadas"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2003, 10, 21)?, "Día de las Fuerzas Armadas"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2004, 10, 21)?, "Día de las Fuerzas Armadas"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2005, 10, 21)?, "Día de las Fuerzas Armadas"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2006, 4, 14)?, "Día de las Américas; Viernes Santo"),
      ...
      (NaiveDate::from_ymd_res(2006, 10, 21)?, "Día de las Fuerzas Armadas"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2007, 10, 21)?, "Día de las Fuerzas Armadas"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2008, 10, 21)?, "Día de las Fuerzas Armadas"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2009, 10, 21)?, "Día de las Fuerzas Armadas"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2010, 10, 21)?, "Día de las Fuerzas Armadas"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2011, 10, 21)?, "Día de las Fuerzas Armadas"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2012, 10, 21)?, "Día de las Fuerzas Armadas"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2013, 10, 21)?, "Día de las Fuerzas Armadas"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2014, 10, 21)?, "Día de las Fuerzas Armadas"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2017, 4, 14)?, "Día de las Américas; Viernes Santo"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2022, 4, 14)?, "Día de las Américas; Jueves Santo"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2028, 4, 14)?, "Día de las Américas; Viernes Santo"),
