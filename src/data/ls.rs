...
pub fn build(years: &Option<&std::ops::Range<Year>>) -> Result<HashMap<Year, BTreeMap<NaiveDate, Holiday>>> {
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2006, 5, 25)?, "Africa/Heroes Day; Ascension Day"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2017, 5, 25)?, "Africa/Heroes Day; Ascension Day"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2028, 5, 25)?, "Africa/Heroes Day; Ascension Day"),
