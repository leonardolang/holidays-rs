...
pub fn build(years: &Option<&std::ops::Range<Year>>) -> Result<HashMap<Year, BTreeMap<NaiveDate, Holiday>>> {
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2007, 5, 17)?, "Kristi himmelfartsdag"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2008, 5, 1)?, "Kristi himmelfartsdag"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2012, 5, 17)?, "Kristi himmelfartsdag"),
