...
pub fn build(years: &Option<&std::ops::Range<Year>>) -> Result<HashMap<Year, BTreeMap<NaiveDate, Holiday>>> {
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2000, 8, 20)?, "Az államalapítás ünnepe"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2001, 8, 20)?, "Az államalapítás ünnepe"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2002, 8, 20)?, "Az államalapítás ünnepe"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2003, 8, 20)?, "Az államalapítás ünnepe"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2004, 8, 20)?, "Az államalapítás ünnepe"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2005, 8, 20)?, "Az államalapítás ünnepe"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2006, 8, 20)?, "Az államalapítás ünnepe"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2007, 8, 20)?, "Az államalapítás ünnepe"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2008, 8, 20)?, "Az államalapítás ünnepe"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2009, 8, 20)?, "Az államalapítás ünnepe"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2010, 8, 20)?, "Az államalapítás ünnepe"),
      ...
      (NaiveDate::from_ymd_res(2010, 12, 24)?, "Pihenőnap (2010. 12. 11.-től helyettesítve)"),
    ],
    &mut map,
    Country::HU,
    "Hungary",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2011, 8, 20)?, "Az államalapítás ünnepe"),
      ...
      (NaiveDate::from_ymd_res(2011, 3, 14)?, "Pihenőnap (2011. 03. 19.-től helyettesítve)"),
      (NaiveDate::from_ymd_res(2011, 10, 31)?, "Pihenőnap (2011. 11. 05.-től helyettesítve)"),
    ],
    &mut map,
    Country::HU,
    "Hungary",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2012, 8, 20)?, "Az államalapítás ünnepe"),
      ...
      (NaiveDate::from_ymd_res(2012, 3, 16)?, "Pihenőnap (2012. 03. 24.-től helyettesítve)"),
      (NaiveDate::from_ymd_res(2012, 4, 30)?, "Pihenőnap (2012. 04. 21.-től helyettesítve)"),
      (NaiveDate::from_ymd_res(2012, 10, 22)?, "Pihenőnap (2012. 10. 27.-től helyettesítve)"),
      (NaiveDate::from_ymd_res(2012, 11, 2)?, "Pihenőnap (2012. 11. 10.-től helyettesítve)"),
      (NaiveDate::from_ymd_res(2012, 12, 24)?, "Pihenőnap (2012. 12. 15.-től helyettesítve)"),
      (NaiveDate::from_ymd_res(2012, 12, 31)?, "Pihenőnap (2012. 12. 01.-től helyettesítve)"),
    ],
    &mut map,
    Country::HU,
    "Hungary",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2013, 8, 20)?, "Az államalapítás ünnepe"),
      ...
      (NaiveDate::from_ymd_res(2013, 8, 19)?, "Pihenőnap (2013. 08. 24.-től helyettesítve)"),
      (NaiveDate::from_ymd_res(2013, 12, 24)?, "Pihenőnap (2013. 12. 07.-től helyettesítve)"),
      (NaiveDate::from_ymd_res(2013, 12, 27)?, "Pihenőnap (2013. 12. 21.-től helyettesítve)"),
    ],
    &mut map,
    Country::HU,
    "Hungary",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2014, 8, 20)?, "Az államalapítás ünnepe"),
      ...
      (NaiveDate::from_ymd_res(2014, 5, 2)?, "Pihenőnap (2014. 05. 10.-től helyettesítve)"),
      (NaiveDate::from_ymd_res(2014, 10, 24)?, "Pihenőnap (2014. 10. 18.-től helyettesítve)"),
      (NaiveDate::from_ymd_res(2014, 12, 24)?, "Pihenőnap (2014. 12. 13.-től helyettesítve)"),
    ],
    &mut map,
    Country::HU,
    "Hungary",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2015, 8, 20)?, "Az államalapítás ünnepe"),
      ...
      (NaiveDate::from_ymd_res(2015, 1, 2)?, "Pihenőnap (2015. 01. 10.-től helyettesítve)"),
      (NaiveDate::from_ymd_res(2015, 8, 21)?, "Pihenőnap (2015. 08. 08.-től helyettesítve)"),
      (NaiveDate::from_ymd_res(2015, 12, 24)?, "Pihenőnap (2015. 12. 12.-től helyettesítve)"),
    ],
    &mut map,
    Country::HU,
    "Hungary",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2016, 8, 20)?, "Az államalapítás ünnepe"),
      ...
      (NaiveDate::from_ymd_res(2016, 3, 14)?, "Pihenőnap (2016. 03. 05.-től helyettesítve)"),
      (NaiveDate::from_ymd_res(2016, 10, 31)?, "Pihenőnap (2016. 10. 15.-től helyettesítve)"),
    ],
    &mut map,
    Country::HU,
    "Hungary",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2017, 8, 20)?, "Az államalapítás ünnepe"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2018, 8, 20)?, "Az államalapítás ünnepe"),
      ...
      (NaiveDate::from_ymd_res(2018, 3, 16)?, "Pihenőnap (2018. 03. 10.-től helyettesítve)"),
      (NaiveDate::from_ymd_res(2018, 4, 30)?, "Pihenőnap (2018. 04. 21.-től helyettesítve)"),
      (NaiveDate::from_ymd_res(2018, 10, 22)?, "Pihenőnap (2018. 10. 13.-től helyettesítve)"),
      (NaiveDate::from_ymd_res(2018, 11, 2)?, "Pihenőnap (2018. 11. 10.-től helyettesítve)"),
      (NaiveDate::from_ymd_res(2018, 12, 24)?, "Pihenőnap (2018. 12. 01.-től helyettesítve)"),
      (NaiveDate::from_ymd_res(2018, 12, 31)?, "Pihenőnap (2018. 12. 15.-től helyettesítve)"),
    ],
    &mut map,
    Country::HU,
    "Hungary",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2019, 8, 20)?, "Az államalapítás ünnepe"),
      ...
      (NaiveDate::from_ymd_res(2019, 8, 19)?, "Pihenőnap (2019. 08. 10.-től helyettesítve)"),
      (NaiveDate::from_ymd_res(2019, 12, 24)?, "Pihenőnap (2019. 12. 07.-től helyettesítve)"),
      (NaiveDate::from_ymd_res(2019, 12, 27)?, "Pihenőnap (2019. 12. 14.-től helyettesítve)"),
    ],
    &mut map,
    Country::HU,
    "Hungary",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2020, 8, 20)?, "Az államalapítás ünnepe"),
      ...
      (NaiveDate::from_ymd_res(2020, 8, 21)?, "Pihenőnap (2020. 08. 29.-től helyettesítve)"),
      (NaiveDate::from_ymd_res(2020, 12, 24)?, "Pihenőnap (2020. 12. 12.-től helyettesítve)"),
    ],
    &mut map,
    Country::HU,
    "Hungary",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2021, 8, 20)?, "Az államalapítás ünnepe"),
      ...
      (NaiveDate::from_ymd_res(2021, 12, 24)?, "Pihenőnap (2021. 12. 11.-től helyettesítve)"),
    ],
    &mut map,
    Country::HU,
    "Hungary",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2022, 8, 20)?, "Az államalapítás ünnepe"),
      ...
      (NaiveDate::from_ymd_res(2022, 3, 14)?, "Pihenőnap (2022. 03. 26.-től helyettesítve)"),
      (NaiveDate::from_ymd_res(2022, 10, 31)?, "Pihenőnap (2022. 10. 15.-től helyettesítve)"),
    ],
    &mut map,
    Country::HU,
    "Hungary",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2023, 8, 20)?, "Az államalapítás ünnepe"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2024, 8, 20)?, "Az államalapítás ünnepe"),
      ...
      (NaiveDate::from_ymd_res(2024, 8, 19)?, "Pihenőnap (2024. 08. 03.-től helyettesítve)"),
      (NaiveDate::from_ymd_res(2024, 12, 24)?, "Pihenőnap (2024. 12. 07.-től helyettesítve)"),
      (NaiveDate::from_ymd_res(2024, 12, 27)?, "Pihenőnap (2024. 12. 14.-től helyettesítve)"),
    ],
    &mut map,
    Country::HU,
    "Hungary",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2025, 8, 20)?, "Az államalapítás ünnepe"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2026, 8, 20)?, "Az államalapítás ünnepe"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2027, 8, 20)?, "Az államalapítás ünnepe"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2028, 8, 20)?, "Az államalapítás ünnepe"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2029, 8, 20)?, "Az államalapítás ünnepe"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2030, 8, 20)?, "Az államalapítás ünnepe"),
