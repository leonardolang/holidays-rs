...
pub fn build(years: &Option<&std::ops::Range<Year>>) -> Result<HashMap<Year, BTreeMap<NaiveDate, Holiday>>> {
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2000, 2, 6)?, "Chinese New Year (estimated)"),
      ...
      (NaiveDate::from_ymd_res(2000, 2, 7)?, "Chinese New Year (estimated) (observed)"),
    ],
    &mut map,
    Country::SG,
    "Singapore",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2001, 12, 17)?, "Hari Raya Puasa (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2002, 5, 27)?, "Vesak Day (observed)"),
      (NaiveDate::from_ymd_res(2002, 11, 4)?, "Deepavali (observed)"),
    ],
    &mut map,
    Country::SG,
    "Singapore",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2003, 2, 3)?, "Chinese New Year (observed)"),
    ],
    &mut map,
    Country::SG,
    "Singapore",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2004, 2, 2)?, "Hari Raya Haji (observed)"),
      (NaiveDate::from_ymd_res(2004, 11, 15)?, "Hari Raya Puasa (observed)"),
    ],
    &mut map,
    Country::SG,
    "Singapore",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2005, 5, 23)?, "Vesak Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2007, 1, 2)?, "Hari Raya Haji (observed)"),
    ],
    &mut map,
    Country::SG,
    "Singapore",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2009, 8, 10)?, "National Day (observed)"),
      (NaiveDate::from_ymd_res(2009, 9, 21)?, "Hari Raya Puasa (observed)"),
      (NaiveDate::from_ymd_res(2009, 11, 16)?, "Deepavali (observed)"),
    ],
    &mut map,
    Country::SG,
    "Singapore",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2010, 2, 16)?, "Chinese New Year (observed)"),
    ],
    &mut map,
    Country::SG,
    "Singapore",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2011, 11, 7)?, "Hari Raya Haji (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2012, 8, 20)?, "Hari Raya Puasa (observed)"),
    ],
    &mut map,
    Country::SG,
    "Singapore",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2013, 2, 12)?, "Chinese New Year (observed)"),
    ],
    &mut map,
    Country::SG,
    "Singapore",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2014, 10, 6)?, "Hari Raya Haji (observed)"),
    ],
    &mut map,
    Country::SG,
    "Singapore",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2015, 8, 10)?, "National Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2017, 1, 30)?, "Chinese New Year (observed)"),
      (NaiveDate::from_ymd_res(2017, 6, 26)?, "Hari Raya Puasa (observed)"),
    ],
    &mut map,
    Country::SG,
    "Singapore",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2019, 5, 20)?, "Vesak Day (observed)"),
      (NaiveDate::from_ymd_res(2019, 8, 12)?, "Hari Raya Haji (observed)"),
      (NaiveDate::from_ymd_res(2019, 10, 28)?, "Deepavali (observed)"),
    ],
    &mut map,
    Country::SG,
    "Singapore",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2020, 1, 27)?, "Chinese New Year (observed)"),
      (NaiveDate::from_ymd_res(2020, 5, 25)?, "Hari Raya Puasa (observed)"),
      (NaiveDate::from_ymd_res(2020, 8, 10)?, "National Day (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2022, 5, 16)?, "Vesak Day (observed)"),
      (NaiveDate::from_ymd_res(2022, 7, 11)?, "Hari Raya Haji (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2023, 1, 24)?, "Chinese New Year (observed)"),
      (NaiveDate::from_ymd_res(2023, 11, 13)?, "Deepavali (observed)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2024, 2, 12)?, "Chinese New Year (observed)"),
    ],
    &mut map,
    Country::SG,
    "Singapore",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2025, 1, 30)?, "Chinese New Year (estimated)"),
      ...
      (NaiveDate::from_ymd_res(2025, 3, 31)?, "Hari Raya Puasa (estimated) (observed)"),
      (NaiveDate::from_ymd_res(2025, 5, 12)?, "Vesak Day (estimated) (observed)"),
    ],
    &mut map,
    Country::SG,
    "Singapore",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2026, 2, 18)?, "Chinese New Year (estimated)"),
      ...
      (NaiveDate::from_ymd_res(2026, 5, 31)?, "Vesak Day (estimated)"),
      ...
      (NaiveDate::from_ymd_res(2026, 6, 1)?, "Vesak Day (estimated) (observed)"),
      (NaiveDate::from_ymd_res(2026, 8, 10)?, "National Day (observed)"),
    ],
    &mut map,
    Country::SG,
    "Singapore",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2027, 2, 7)?, "Chinese New Year (estimated)"),
      ...
      (NaiveDate::from_ymd_res(2027, 2, 8)?, "Chinese New Year (estimated) (observed)"),
      (NaiveDate::from_ymd_res(2027, 5, 17)?, "Hari Raya Haji (estimated) (observed)"),
    ],
    &mut map,
    Country::SG,
    "Singapore",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2028, 1, 27)?, "Chinese New Year (estimated)"),
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2029, 2, 14)?, "Chinese New Year (estimated); Hari Raya Puasa (estimated)"),
      ...
      (NaiveDate::from_ymd_res(2029, 5, 28)?, "Vesak Day (estimated) (observed)"),
      (NaiveDate::from_ymd_res(2029, 11, 5)?, "Deepavali (observed)"),
    ],
    &mut map,
    Country::SG,
    "Singapore",
  ...
  build_year(
    ...
    vec![
      ...
      (NaiveDate::from_ymd_res(2030, 2, 4)?, "Chinese New Year (estimated); Hari Raya Puasa (estimated)"),
      ...
      (NaiveDate::from_ymd_res(2030, 2, 5)?, "Chinese New Year (estimated) (observed)"),
    ],
    &mut map,
    Country::SG,
    "Singapore",
